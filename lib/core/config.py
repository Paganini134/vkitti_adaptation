...
config.DATASET.ROOT = "/mnt/MIG_archive24/Datasets/iota/Veda/RAFT-3D/data/3DPose/"
config.DATASET.TEST_CAM_SEQ = "Campus_Seq1"   # selects that sequence under ROOT
config.DATASET.TRAIN_DATASET = 'campus_seq1'
config.DATASET.TEST_DATASET = 'campus_seq1'
...
config.DATASET.TRAIN_CAM_SEQ = 'Campus_Seq1'
config.DATASET.TEST_CAM_SEQ = 'Campus_Seq1'
